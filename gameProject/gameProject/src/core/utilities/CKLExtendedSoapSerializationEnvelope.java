...
public class CKLExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(CKLDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new CKLStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static CKLDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static CKLDateTimeConverter dateTimeConverter = new CKLStandardDateTimeConverter();

    public CKLExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public CKLExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new CKLMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!= String.class  )) {
                String xmlName= CKLHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,CKLExtendedSoapSerializationEnvelope.class);
    ...
    public static Object getXSDType(Object param)
    {
        ...
        String xmlName= CKLHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
