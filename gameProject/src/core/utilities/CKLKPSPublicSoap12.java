...
public class CKLKPSPublicSoap12
{
    interface CKLIWcfMethod
    {
        CKLExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws Exception;

        Object ProcessResult(CKLExtendedSoapSerializationEnvelope __envelope, Object result) throws Exception;
    }
    ...
    public CKLKPSPublicSoap12(){}

    public CKLKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public CKLKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected CKLExtendedSoapSerializationEnvelope createEnvelope()
    {
        CKLExtendedSoapSerializationEnvelope envelope= new CKLExtendedSoapSerializationEnvelope(CKLExtendedSoapSerializationEnvelope.VER12);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected List sendRequest(String methodName, CKLExtendedSoapSerializationEnvelope envelope, Transport transport , com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws Exception
    {
    ...
    Object getResult(Class destObj, Object source, String resultName, CKLExtendedSoapSerializationEnvelope __envelope) throws Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws Exception
    {
        ...
        return (Boolean)execute(new CKLIWcfMethod()
        {
            @Override
            public CKLExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                CKLExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public Object ProcessResult(CKLExtendedSoapSerializationEnvelope __envelope, Object __result)throws Exception {
    ...
    protected Object execute(CKLIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws Exception
    {
        Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        CKLExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected Exception convertToException(org.ksoap2.SoapFault fault, CKLExtendedSoapSerializationEnvelope envelope)
    {
