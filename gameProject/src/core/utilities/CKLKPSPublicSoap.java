...
public class CKLKPSPublicSoap
{
    ...
    public CKLKPSPublicSoap(){}

    public CKLKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public CKLKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        CKLExtendedSoapSerializationEnvelope envelope= new CKLExtendedSoapSerializationEnvelope(CKLExtendedSoapSerializationEnvelope.VER11);
