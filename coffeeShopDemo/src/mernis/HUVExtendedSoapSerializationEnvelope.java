...
public class HUVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(HUVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new HUVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static HUVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static HUVDateTimeConverter dateTimeConverter = new HUVStandardDateTimeConverter();

    public HUVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public HUVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new HUVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=HUVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,HUVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=HUVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
