...
public class HUVKPSPublicSoap
{
    ...
    public HUVKPSPublicSoap(){}

    public HUVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public HUVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        HUVExtendedSoapSerializationEnvelope envelope= new HUVExtendedSoapSerializationEnvelope(HUVExtendedSoapSerializationEnvelope.VER11);
